...
{/* Count display */}
      <Box position="relative" display="flex" alignItems="center" justifyContent="center">
        <Box
          ...
          style={{
            ...
            height: '220px',
            borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(116, 200, 152, 0.1) 0%, transparent 70%)',
            pointerEvents: 'none',
          }}
        />
           <span
          ...
          style={{
            ...
            fontFamily: "'Syne', sans-serif",
            background: 'linear-gradient(135deg, #FFFFFF 40%, rgba(116, 200, 152, 0.9) 100%)',
      ...
      <button
        ...
        onMouseEnter={e => {
          ...
          (e.currentTarget).style.boxShadow = '0 8px 32px rgba(116, 200, 152, 0.35)';
        }}
        onMouseLeave={e => {
